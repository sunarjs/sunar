...
const BentoCard = ({ name, className, background, icon: Icon, description, href, cta, ...props }: BentoCardProps) => (
    <div
        key={name}
        className={cn(
...
export { BentoCard, BentoGrid, type BentoCardProps, type BentoGridProps };
