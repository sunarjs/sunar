...
<Steps>
    ...
    <Step>
        ...
        The [`CooldownContext`](https://github.com/search?q=repo%3Asunarjs%2Fsunar+path%3Apackages%2Fsunar%2Fsrc%2Ftypes%cooldown.ts+CooldownContext&type=code) object contains information such as the remaining cooldown time, which you can use to inform the user accordingly.
    </Step>
</Steps>
