...
export default function HomePage() {
	return (
		<main className="h-min-screen flex flex-col py-2">
			...
			<section className="flex w-full flex-col items-center justify-center gap-y-4 border-x border-b bg-gradient-to-b from-background to-muted/50 px-4 py-8 sm:gap-y-8 sm:px-0 md:py-12 lg:py-16">
